  ...
  <div class="w-full mx-auto">
    <div>
      ...
      <div class="w-11/12 md:w-7/12 mx-auto my-3">
        <div
          class="text-center text-3xl font-bold border-b-2 mb-3 bg-linear-to-br from-orange-300 to-red-700 text-transparent bg-clip-text">
          成員介紹
        </div>
        <div
      ...
      <div class="w-full text-center px-3 md:w-8/12 mx-auto py-9">
        <div
          class="text-center text-3xl font-bold mb-3 bg-linear-to-br from-orange-300 to-red-700 text-transparent bg-clip-text">
          聯絡我們
        </div>
...
v 1.0.7
將 TailwindCSS 更新至 v4，修復部分顯示錯誤，優化部分功能。<br />
`);
